...
from core.resume.latex_engine import LaTeXEngine, escape_latex
...
class NomadV3EngineTestCase(TestCase):
    ...
    def test_document_loader_and_detector(self):
        from core.documents.detector import SectionDetector
    ...
    def test_latex_jinja_rendering(self):
        from core.resume.templates import get_or_create_default_template, ResumeTemplateRenderer
    ...
    def test_multi_format_downloads(self):
        ...
        url = reverse('v3-resume-download', kwargs={'version_id': version.id}) + "?output=html"
